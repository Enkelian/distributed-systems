...
if '_t_Longs' not in _M_Demo.__dict__:
    _M_Demo._t_Longs = IcePy.defineSequence('::Demo::Longs', (), IcePy._t_long)
...
if 'CalcPrx' not in _M_Demo.__dict__:
    ...
    class CalcPrx(Ice.ObjectPrx):
        ...
        def avg(self, nums, context=None):
            return _M_Demo.Calc._op_avg.invoke(self, ((nums, ), context))

        def avgAsync(self, nums, context=None):
            return _M_Demo.Calc._op_avg.invokeAsync(self, ((nums, ), context))

        def begin_avg(self, nums, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Calc._op_avg.begin(self, ((nums, ), _response, _ex, _sent, context))
    ...
    class Calc(Ice.Object):
        ...
        def avg(self, nums, current=None):
    ...
    Calc._op_add = IcePy.Operation('add', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), ((), IcePy._t_long, False, 0), ())
    Calc._op_subtract = IcePy.Operation('subtract', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), IcePy._t_int, False, 0), ((), IcePy._t_int, False, 0)), (), ((), IcePy._t_long, False, 0), ())
    ...
    Calc._op_avg = IcePy.Operation('avg', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), _M_Demo._t_Longs, False, 0),), (), ((), IcePy._t_float, False, 0), ())
